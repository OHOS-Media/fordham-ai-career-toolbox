...
const Hero = ({ title, gradientTitle, description, ctaText }) => {
  return (
    <div className="relative flex flex-col items-center justify-center text-center z-10 space-y-3 md:space-y-4 px-4 md:px-0">
      <div className="max-w-2xl flex flex-col items-center space-y-3 md:space-y-6 mb-3 md:mb-6">
        <TextGenerateEffect
          words={`${title}`}
          className="font-bold h3 md:h1 text-fordham-white"
          duration={0.4}
        />
