...
export default function Home({ HomePageData }) {
  return (
    <div className="flex flex-col items-center justify-center gap-10 md:gap-20 mt-20 md:mt-[160px]">
      <GradientContainer>
        <PageContainer limitedWidth={true}>
          <div className="flex flex-col items-center justify-center gap-10 md:gap-[160px]">
