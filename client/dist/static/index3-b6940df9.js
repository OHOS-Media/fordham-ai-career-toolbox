...
const st = [];
function it(e) {
  const { children: n, flatIndex: t, index: s, params: r, payload: o, siblingIndex: a } = e,
    { navigate: i, navigateIntent: l, resolvePathFromState: f } = J(),
    u = q(),
    { panes: m, expand: y } = Re(),
    c = p.useMemo(() => (u == null ? void 0 : u.panes) || st, [u == null ? void 0 : u.panes]),
    ...
    w = p.useCallback(
      (x) => {
        const P = v(x);
        return setTimeout(() => i(P), 0), P;
      },
      [v, i]
    ),
    b = p.useCallback(
      (x) => {
        const P = v((j, S) => [...j.slice(0, a), { ...S, params: x }, ...j.slice(a + 1)]);
        return f(P);
      },
      [v, f, a]
    ),
    g = p.useCallback(
      (x) => {
        w((P, j) => [...P.slice(0, a), { ...j, payload: x }, ...P.slice(a + 1)]);
      },
      [w, a]
    ),
    E = p.useCallback(
      (x) => {
        w((P, j) => [...P.slice(0, a), { ...j, params: x }, ...P.slice(a + 1)]);
      },
      [w, a]
    ),
    k = p.useCallback(
      ({ id: x, parentRefPath: P, type: j, template: S }) => {
        i({
          panes: [
            ...c.slice(0, I + 1),
            [
              {
                id: x,
                params: { template: S.id, parentRefPath: Te(P), type: j },
                payload: S.params,
              },
            ],
          ],
    ...
    C = p.useMemo(
      () => ({
        ...
        payload: o,
        params: r,
        hasGroupSiblings: c[I] ? c[I].length > 1 : !1,
        groupLength: c[I] ? c[I].length : 0,
        routerPanesState: c,
        ChildLink: De,
        BackLink: t ? $e : void 0,
        ...
        replaceCurrent: (x = {}) => {
          w(() => [{ id: x.id || "", payload: x.payload, params: x.params || {} }]);
        },
        closeCurrent: () => {
          w((x, P) => (x.length > 1 ? x.filter((j) => j !== P) : x));
        },
        closeCurrentAndAfter: (x = !0) => {
          x && h && y(h.element), i({ panes: [...c.slice(0, I)] });
        },
        duplicateCurrent: (x) => {
          w((P, j) => {
            const S = {
              ...j,
              payload: (x == null ? void 0 : x.payload) || j.payload,
              params: (x == null ? void 0 : x.params) || j.params,
            };
            return [...P.slice(0, a), S, ...P.slice(a)];
          });
        },
        setView: (x) => {
          const P = le(r, "view");
          return E(x ? { ...P, view: x } : P);
        },
        setParams: E,
        setPayload: g,
        createPathWithParams: b,
        navigateIntent: l,
      }),
      [t, I, a, o, r, c, k, E, g, b, l, w, h, i, y]
    );
  return d.jsx(Me.Provider, { value: C, children: n });
}
class T extends Error {
  constructor({ message: t, context: s, helpId: r, cause: o }) {
    ...
    $(this, "context");
    $(this, "helpId");
    (this.name = "PaneResolutionError"), (this.context = s), (this.helpId = r), (this.cause = o);
  }
}
...
const ot = (e) => !!e && typeof (e == null ? void 0 : e.then) == "function",
  lt = (e) => (X(e) ? typeof e.serialize == "function" : !1),
  dt = (e) => (n, t, s) => {
    try {
      return e(n, t, s);
    } catch (r) {
      throw r instanceof T
        ? r
        : new T({
            message: typeof (r == null ? void 0 : r.message) == "string" ? r.message : "",
            context: t,
            cause: r,
          });
    }
...
function he(e, n) {
  ...
  if (typeof s != "function")
    throw new Error(`Expected property \`${n}\` to be a function but got ${typeof s} instead.`);
  const r = s.bind(e);
...
async function ct(e) {
  const n = new Map(),
    t = pe((a) => (i, l, f) => {
      const u = i && `${W(i)}-${l.path.join("__")}`,
        m = u && n.get(u);
      if (m) return m;
      const y = a(i, l, f);
      return u && n.set(u, y), y;
    }),
    s = [
      [
        {
  ...
  async function r({
    ...
    return g.type === "document" && g.id === v
      ? [
          {
            panes: [
              ...m.slice(0, m.length - 1).map((k) => [{ id: k }]),
              [{ id: v, params: b, payload: y }],
            ],
            depthIndex: m.length,
            levelIndex: h,
          },
        ]
      : ((E = g.canHandleIntent) != null && E.call(g, l, f, { pane: g, index: i })) ||
          (g.type === "documentList" &&
            g.schemaTypeName === w &&
            g.options.filter === "_type == $type")
        ? [
            {
              panes: [...m.map((k) => [{ id: k }]), [{ id: f.id, params: b, payload: y }]],
              depthIndex: m.length,
              levelIndex: h,
            },
          ]
                ...
                g.items.map((k, C) =>
                  k.type === "divider"
                    ...
                    : r({
                        ...
                        path: [...m, k.id],
                        payload: y,
                        unresolvedPane: typeof g.child == "function" ? he(g, "child") : g.child,
                        levelIndex: C,
                        structureContext: I,
                      })
                )
  ...
  const o = (
    ...
    a.depthIndex === i.depthIndex ? a.levelIndex - i.levelIndex : a.depthIndex - i.depthIndex
  )[0];
  return o ? o.panes : s;
}
const pt = (e, n) => {
...
function M({
  ...
  try {
    return r(e, f, a.flatIndex).pipe(
      Z((u) => {
        const m = { type: "resolvedMeta", ...a, paneNode: u, path: f.path },
          y = i.map((h, I) => ({
            type: "loading",
            path: [...f.path, ...i.slice(I).map((v, w) => `[${h.flatIndex + w}]`)],
            paneNode: null,
            ...h,
          }));
        ...
        return (
          l != null && l.routerPaneSibling.id.startsWith("__edit__")
            ...
            : a.groupIndex === (l == null ? void 0 : l.groupIndex)
              ...
              : (c = M({
                  unresolvedPane: typeof u.child == "function" ? he(u, "child") : u.child,
                  flattenedRouterPanes: i,
                  parent: u,
                  path: f.path,
                  resolvePane: r,
    ...
    if (
      ...
      (u.context &&
        console.warn(
          `Pane resolution error at index ${u.context.index}${u.context.splitIndex > 0 ? ` for split pane index ${u.context.splitIndex}` : ""}: ${u.message}${u.helpId ? ` - see ${ue(u.helpId)}` : ""}`,
          u
        ),
  ...
  return e
    .pipe(
      ...
      R((r) =>
        r
          .flatMap((o, a) =>
            o.map((i, l) => ({ routerPaneSibling: i, groupIndex: a, siblingIndex: l }))
          )
      ...
      R(([r, o]) => {
        for (let a = 0; a < o.length; a++) {
          const i = r[a],
            l = o[a];
          if (!Y(i, l)) return { flattenedRouterPanes: o, diffIndex: a };
        }
      ...
      ne((r, o) => {
        const { cacheKeysByFlatIndex: a, resolvedPaneCache: i } = r,
          ...
          u = a.slice(0, f + 1),
          m = a.slice(f + 1),
          y = new Set(u.flatMap((h) => Array.from(h))),
          c = m.flatMap((h) => Array.from(h)).filter((h) => !y.has(h));
        for (const h of c) i.delete(h);
        return {
          flattenedRouterPanes: l,
          cacheKeysByFlatIndex: a,
          resolvedPaneCache: i,
          resolvePane: pe((h) => (I, v, w) => {
            const b = I && `${W(I)}-${ht(v)}`,
              g = b && i.get(b);
            if (g) return g;
            const E = h(I, v, w);
            if (!b) return E;
            const k = a[w] || new Set();
            return k.add(b), (a[w] = k), i.set(b, E), E;
          }),
        };
      }, t),
      Z(({ flattenedRouterPanes: r, resolvePane: o }) =>
        M({
          unresolvedPane: n,
...
function ft() {
  const e = p.useMemo(() => new Ye(1), []),
    n = p.useMemo(() => e.asObservable().pipe(R((s) => (s == null ? void 0 : s.panes) || [])), [e]),
    { state: t } = J();
  return (
    p.useEffect(() => {
      e.next(t);
...
function yt() {
  ...
  const { structureContext: t, rootPaneNode: s } = A(),
    [r, o] = p.useState({ paneDataItems: [], resolvedPanes: [], routerPanes: [] }),
    a = ft();
  return (
    p.useEffect(() => {
      const i = mt({ rootPaneNode: s, routerPanesStream: a, structureContext: t })
        .pipe(
          R((l) => {
            const f = l.reduce((y, c) => {
                const h = y[c.groupIndex] || [];
                return (h[c.siblingIndex] = c.routerPaneSibling), (y[c.groupIndex] = h), y;
              }, []),
              u = f.length,
              m = l.map((y) => {
                const {
                ...
                return {
                  ...
                  itemId: v.id,
                  groupIndex: c,
                  key: `${y.type === "loading" ? "unknown" : y.paneNode.id}-${b}-${I}`,
            ...
            return { paneDataItems: m, routerPanes: f, resolvedPanes: m.map((y) => y.pane) };
          })
        )
...
async function xt(e, n, t) {
  ...
  if (!n && t) return { id: Ue(), type: t };
  if (n && !t) {
    const s = await ce(e.resolveTypeForDocument(n));
    return { id: n, type: s };
  }
  throw new T({
    ...
    const { navigate: e } = J(),
      n = q(
        p.useCallback((i) => {
          ...
          return l
            ? { intent: l, params: X(i.params) ? i.params : gt, payload: i.payload }
            : void 0;
        }, [])
      ),
      ...
      p.useEffect(() => {
        if (n) {
          ...
          async function m() {
            ...
            const h = await ct({
              intent: i,
              params: { ...l, id: y, type: c },
              payload: f,
              rootPaneNode: t,
              structureContext: s,
            });
            u || e({ panes: h }, { replace: !0 });
          }
          return (
            m().catch(a),
            () => {
...
function jt({ error: e }) {
  ...
  return d.jsx(N, {
    ...
    children: d.jsxs(de, {
      children: [
        d.jsx(Ne, { as: "h2", children: t("structure-error.header.text") }),
        d.jsxs(N, {
          marginTop: 4,
          padding: 4,
          radius: 2,
            ...
            o.length > 0 &&
              d.jsxs(U, {
                ...
                children: [
                  ...
                  d.jsx(Q, {
                    children: o.slice(1).map((l, f) => d.jsx(Pt, { children: l }, `${l}-${f}`)),
                  }),
                ],
              }),
            d.jsxs(U, {
              ...
              space: 2,
              children: [
                d.jsx(_, { size: 1, weight: "medium", children: t("structure-error.error.label") }),
                d.jsx(Q, { children: r ? wt(s) : e.message }),
              ],
            }),
            a &&
              d.jsx(O, {
...
const bt = {
    component: p.lazy(() =>
      L(
        () => import("./index-eaa8fd91.js"),
        ["static/index-eaa8fd91.js", "static/sanity-206b9142.js"]
      )
    ),
    document: p.lazy(() =>
      L(() => import("./sanity-206b9142.js").then((e) => e.aY), []).then(function (e) {
        return e.pane;
      })
    ),
    documentList: p.lazy(() =>
    ...
    list: p.lazy(() =>
      L(
        () => import("./index2-b5453b3e.js"),
        ["static/index2-b5453b3e.js", "static/sanity-206b9142.js"]
      )
    ),
  },
  kt = p.memo(
    function (e) {
      ...
      return d.jsx(it, {
        ...
        children: d.jsx(p.Suspense, {
          fallback: d.jsx(K, { paneKey: i, path: u, selected: m }),
          children: d.jsx(c, {
            childItemId: t || "",
            index: r,
            itemId: o,
    ...
    ({ params: e = {}, payload: n = null, ...t }, { params: s = {}, payload: r = null, ...o }) => {
      if (!Y(e, s) || !Y(n, r)) return !1;
    ...
    children: d.jsx(te, {
      ...
      children: d.jsx(de, {
        ...
        children: d.jsx(N, {
          ...
          children: d.jsxs(te, {
            children: [
              d.jsx(O, { children: d.jsx(_, { size: 1, children: d.jsx(He, {}) }) }),
              d.jsxs(U, {
                flex: 1,
                marginLeft: 3,
                space: 3,
...
const _t = (e) => {
    const { documentId: n, documentType: t } = e,
      ...
      l = r.get(t),
      { value: f, isLoading: u } = qe({ enabled: !0, schemaType: l, value: i }),
      m = a
        ? o("browser-document-title.new-document", {
            schemaType: (l == null ? void 0 : l.title) || (l == null ? void 0 : l.name),
          })
        : (f == null ? void 0 : f.title) || o("browser-document-title.untitled-document"),
      y = s.ready && !u,
      c = me(m);
    return (
      p.useEffect(() => {
    ...
    return Rt(t)
      ...
      : Ct(t)
        ? t != null && t.title
          ...
          : d.jsx(_t, { documentId: t.options.id, documentType: t.options.type })
...
`,
  ...
  $t = p.memo(function ({ onPaneChange: e }) {
    ...
    const { push: n } = je(),
      ...
      i = q(p.useCallback((h) => typeof h.intent == "string", [])),
      {
        sanity: { media: l },
      } = ve(),
      [f, u] = p.useState(null),
    ...
    return (
      ...
      p.useEffect(() => {
        ...
        return (
          window.addEventListener("keydown", h), () => window.removeEventListener("keydown", h)
        );
      }, [n]),
      (c = t._original) != null && c.types.some(be)
        ? d.jsxs(ke, {
            element: f || null,
            children: [
              d.jsxs(Tt, {
                ...
                children: [
                    ...
                    ({
                      ...
                      d.jsx(
                        p.Fragment,
                        {
                          children:
                            g === D
                              ? d.jsx(K, { paneKey: b, path: C, selected: j })
                              : d.jsx(kt, {
                                  active: h,
                                  groupIndex: v,
                                  index: E,
                  ...
                  o.length <= 1 && i && d.jsx(K, { paneKey: "intent-resolver" }),
                ],
              }),
              d.jsx(St, { resolvedPanes: a }),
              d.jsx("div", { "data-portal": "", ref: u }),
            ],
          })
        : d.jsx(Et, {})
    );
    ...
    : d.jsx(_e, {
        ...
        children: d.jsx(Se, {
          ...
          children: d.jsxs(Ce, {
            ...
            structure: o,
            children: [d.jsx($t, { onPaneChange: H }), d.jsx(It, {})],
          }),
        }),
      });
}
